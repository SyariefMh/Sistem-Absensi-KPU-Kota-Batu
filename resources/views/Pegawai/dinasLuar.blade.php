        ...
        <div class="container d-flex justify-content-center">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <div class="card p-4">
                        <p class="text-center" style="color: #C72B41; font-weight: 800; padding-bottom: 20px">Form
                            Absensi Dinas Luar</p>
                        ...
                        {{-- Upload surat --}}
                        <div class="mb-3">
                            <label for="formFileDisabled" class="form-label">Surat Tugas</label>
                            <input class="form-control" type="file" id="formFileDisabled" name="file">
                        </div>

                        {{-- Lokasi --}}
                        <p class="text-center">Lokasi saat ini</p>
                        ...
                        <div class="d-flex justify-content-around">
                            <button class="btn btn-danger" style="margin-top: 10px" type="submit">Simpan</button>
                            <button class="btn btn-danger" style="margin-top: 10px" onclick="refreshMap()">Refresh
                                Map</button>
                        </div>
