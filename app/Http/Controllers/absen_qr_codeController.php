...
class absen_qr_codeController extends Controller
{
    ...
    {
        return view('satpam.codeSatpam');
    }

    public function scanQrCodeDatangAdmin(Request $request)
    {
    ...
    public function scanQrCodeDatangKasubag(Request $request)
    {
        $qrCodeData = $request->input('qrcodefilesDtg');
        $qrCodes = qrcodeGen::where('qrcode_datang', $qrCodeData) // Use $desiredUserId directly as the user ID
            ->first();
    ...
    public function scanQrCodeDatangSatpam(Request $request)
    {
        $qrCodeData = $request->input('qrcodefilesDtg');
        $qrCodes = qrcodeGen::where('qrcode_datang', $qrCodeData) // Use $desiredUserId directly as the user ID
            ->first();
