...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="container">
            <form action="{{ url('dashboardPegawai/profile/update/' . $users->id) }}" method="POST"
                ...
                <a href="{{ url('dashboardPegawai') }}" class="btn btn-secondary">Back to Kepegawaian</a>
